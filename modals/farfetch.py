        ...
        if user_details:
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    # Initialize default values in case scraping fails
                    brandname234 = "Farfetch"
                    productname = "Luxury Item"
                    productimage = "https://cdn-images.farfetch-contents.com/content/images/omni-logo-ff-v2.png"
                    ...
                    try:
                        ...
                        if brandname1:
                            ...
                            if brandname2:
                                ...
                                if brandname3:
                                    brand_element = brandname3.find('a', {'class': 'ltr-183yg4m-Body-Heading-HeadingBold e1h8dali1'})
                                    if brand_element and brand_element.text:
                                        brandname234 = brand_element.text.strip()
                        ...
                        if productname1:
                            ...
                            if productname2:
                                ...
                                if productname3:
                                    product_element = productname3.find('p', {'class': 'ltr-13ze6d5-Body efhm1m90'})
                                    if product_element and product_element.text:
                                        productname = product_element.text.strip()
                        ...
                        print(f"    [{Colors.red}Error{lg}] Scraping error: {str(e)}" + lg)
